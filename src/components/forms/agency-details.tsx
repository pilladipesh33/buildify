  ...
  const handleDeleteAgency = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Deleted you agency and all subaccount",
      });
      router.refresh();
    } catch (error) {
      console.log(error);
    ...
    <AlertDialog>
      <Card className="w-full">
        ...
        <CardContent>
                ...
                {data?.id && (
                  <div className="flex flex-col gap-2">
                    ...
                    <NumberInput
                      ...
                      min={1}
                      className="bg-dark-tremor-background-emphasis
                    !border !border-input"
          ...
          {data?.id && (
            <>
              <div className="flex flex-row items-center justify-between rounded-lg border border-destructive gap-6 p-4 mt-4">
                <div>
